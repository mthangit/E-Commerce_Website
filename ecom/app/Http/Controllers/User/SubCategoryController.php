...
class SubCategoryController extends Controller
{
    public function Index(Request $request)
    {
        ...
        $products = $products->where('productSubCategoryID', $subCategory->subCategoryID)->where('productCategoryID', $category->categoryID)->paginate(12);
    ...
    public function Index2(Request $request)
    {
        ...
        $products = $products->where('productCategoryID', $category_list->categoryID)->paginate(12);
