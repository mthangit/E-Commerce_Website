                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('updateproduct') }}" method="POST" id="productForm" name="productForm">
                                ...
                                <select class="form-control" id="productBrandID" name="productBrandID"
                                    ...
                                    @foreach ($brands as $brand)
                                        <option value="{{ $brand->brandID }}"
                                            {{ $product_info->productBrandID == $brand->brandID ? 'selected' : '' }}>
                                            {{ $brand->brandName }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select class="form-control" id="productCategoryID" name="productCategoryID"
                                    ...
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->categoryID }}"
                                            {{ $product_info->productCategoryID == $category->categoryID ? 'selected' : '' }}>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" id="productSubCategoryID" name="productSubCategoryID"
                                    aria-label="Default select example">
                                    <option value=""
                                        {{ empty($product_info->productSubCategoryID) ? 'selected' : '' }}></option>
                                    @foreach ($subcategories as $subcategory)
                                        <option class="subcategory" data-category="{{ $subcategory->categoryID }}"
                                            value="{{ $subcategory->subCategoryID }}"
                                            {{ $product_info->productSubCategoryID == $subcategory->subCategoryID ? 'selected' : '' }}>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="productOriginalPrice"
                                    name="productOriginalPrice" value="{{ $product_info->productOriginalPrice }}" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="productDiscountPrice"
                                    name="productDiscountPrice" value="{{ $product_info->productDiscountPrice }}" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="productBarcode" name="productBarcode"
                                    value="{{ $product_info->productBarcode }}" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="productInStock" name="productInStock"
                                    value="{{ $product_info->productInStock }}" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="productInStock" name="productInStock"
                                    value="{{ $product_info->productSoldQuantity }}" readonly />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                @if ($product_info->productImage)
                                    <img style="height:100px" src="{{ asset($product_info->productImage) }}"
                                        alt="">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="file" name="productSideImageOne"
                                    id="productSideImageOne" />
                                @if ($product_info->productImage)
                                    <img style="height:100px" src="{{ asset($product_info->productSideImage1) }}"
                                        alt="">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="file" name="productSideImageTwo"
                                    id="productSideImageTwo" />
                                @if ($product_info->productSideImage1)
                                    <img style="height:100px" src="{{ asset($product_info->productSideImage2) }}"
                                        alt="">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="file" name="productSideImageThree"
                                    id="productSideImageThree" />
                                @if ($product_info->productImage)
                                    <img style="height:100px" src="{{ asset($product_info->productSideImage3) }}"
                                        alt="">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="datetime-local" class="form-control" id="productCreatedDate"
                                    name="productCreatedDate" value="{{ $product_info->productCreatedDate }}" readonly />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="categoryModifiedDate">Category Modified
                                Date</label>
                            <div class="col-sm-10">
                                <input type="datetime-local" class="form-control" id="productModifiedDate"
                                    name="productModifiedDate" value="{{ $product_info->productModifiedDate }}"
                                    readonly />
                            </div>
                        </div>
