      ...
      <div class="input-group mb-3">
        ...
        <div class="dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="filterDropdown">
            ...
            <a class="dropdown-item" href="{{ route('allbrand', ['status' => 'available']) }}">Chỉ hiển thị Available</a>
            <a class="dropdown-item" href="{{ route('allbrand', ['status' => 'unavailable']) }}">Chỉ hiển thị Unavailable</a>
          </div>
        </div>
        ...
        <tbody class="table-border-bottom-0">
          ...
          <tr>
            ...
            <td>
              ...
              @if($brand->isActive == 1)
              <a href="{{route('deletebrand', $brand->brandID)}}" class="btn btn-danger">Xóa</a>
              @else
