            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="productOriginalPrice" name="productOriginalPrice"
                                placeholder="50000" oninput="validateInput(this)" />
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name">Nhập giá khuyến mãi sản
                            phẩm</label>
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="productDiscountPrice" name="productDiscountPrice"
                                placeholder="50000" oninput="validateInput(this)" />
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-end">
                        <div class="col-sm-10">
                            <button type="button" class="btn btn-primary" id="btn-submit">Thêm mới sản phẩm</button>
                        </div>
                    </div>
                    {{-- </form> --}}
                </div>
