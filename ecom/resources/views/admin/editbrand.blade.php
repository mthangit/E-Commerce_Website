...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Page/</span>Sửa thương hiệu/h4>
    <div class="col-xxl">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('updatebrand') }}" method="POST">
                    @csrf
                    <input type="hidden" class="form-control" id="brandID" name="brandID" value="{{$brandInfo->brandID}}" />
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name">Tên thương hiệu</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="brandName" name="brandName" value="{{$brandInfo->brandName}} " />
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="brandDescription" name="brandDescription" value="{{$brandInfo->brandDescription}}" />
                        </div>
                    </div>
