<footer>
        <div class="footer-wrapper grid-3-col">
            ...
            <div class="about-us">
                ...
                <div class="privacy-policy"><a href="{{route('privacy policy')}}" class="heavy-link">Chính sách bảo mật</a></div>
                <div class="terms-of-use"><a href="{{route('term of use')}}" class="heavy-link">Điều khoản sử dụng</a></div>
            </div>
            <div class="page-support">
                <div class="page-support-title">
                    <h4>HỖ TRỢ</h4>
                </div>
                <div class="most-asked-questions"><a href="{{route('most asked questions')}}" class="heavy-link">Các câu hỏi thường gặp</a></div>
                <div class="contact-info"><a href="{{route('contact')}}" class="heavy-link">Thông tin liên hệ</a></div>
                <div class="delivery-policy"><a href="{{route('delivery policy')}}" class="heavy-link">Chính sách vận chuyển</a></div>
                <div class="return-policy"><a href="{{route('return policy')}}" class="heavy-link">Chính sách đổi trả</a></div>
                <div class="send-support"><a href="{{route('contact')}}" class="heavy-link">Gửi yêu cầu hỗ trợ</a></div>
            </div>
        </div>
        <div class="copyright">
