                            ...
                            <div class="row d-flex justify-content-between align-items-center">
                                ...
                                <div class="col-md-3 col-lg-3 col-xl-2 d-flex">
                                    ...
                                    <input id="{{ $inputId }}" min="1" name="quantity"
                                        ...
                                        class="form-control quantity-input" inputmode="numeric" pattern="[0-9]*" />
                                    <button class="btn btn-link px-2 add" data-rowID="{{ $product->rowId }}">
                                        <i class="fas fa-plus"></i>
                                    </button>
                                </div>
                                <div class="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                                    <h5 class="mb-0 txt-16">{{ formatCurrency($product->price * $product->qty) }}
                                        &#8363;</h5>
                                </div>
                                <div class="col-md-1 col-lg-1 col-xl-1 text-end">
                                    <a href="{{ route('delete cart', ['rowID' => $product->rowId]) }}"
                                        class="text-danger" id="delete-item" data-rowid="{{ $product->rowId }}"><i
                ...
                <div class="card1">
                    <div class="card-body">
                        <div class="total mb-lg-5">
                            ...
                            <span class="tb-header right txt-18 txt-orange">{{ formatCurrency($totalPrice) }}
                                &#8363;</span>
                        </div>
