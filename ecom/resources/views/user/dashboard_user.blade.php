                ...
                @foreach($flashSaleProducts as $flashSaleProduct)
                    <div class="flash-sale-product">
                        <div class="product-ping width-common relative">
                            <a href="{{route('detail product',['categorySlug'=>getCategoryByProductID($flashSaleProduct->productID)->categorySlug,'subCategorySlug'=>getSubCategoryByProductID($flashSaleProduct->productID)->subCategorySlug,'productSlug'=>$flashSaleProduct->productSlug])}}" class="image-common relative">
                                <div class="product-img sale">
                                    <img src="{{asset($flashSaleProduct->productImage)}}"
                                         alt="" height="200" width="200">
                                    <span class="sale-percent">{{(1 - round($flashSaleProduct->productDiscountPrice / $flashSaleProduct->productOriginalPrice, 2)) * 100 .'%'}}</span>
                                </div>
                                <div class="product-info">
                                    <div class="width-common price-block">
                                        <strong class="discount-price txt-16">{{formatCurrency($flashSaleProduct->productDiscountPrice)}} &#8363;</strong>
                                        <span class="original-price txt-12 right">{{$flashSaleProduct->productOriginalPrice}} &#8363;</span>
                                    </div>
                                    <div class="product-name-block">
                                        <h3 class="width-common pr-name sp-bottom-5">
                                            <div class="product-name cyan-link">{{$flashSaleProduct->productName}}</div>
                                        </h3>
                                    </div>
        ...
        <div class="suggested-blog-content">
            <div class="preview-blog grid-3-col">
                <div class="blog-ping width-common relative">
                    <a href="" class="blog-home relative">
                        <div class="blog-img">
                            <img src="https://media.hasaki.vn/hsk/sua-tam-thai-lan%20(1).png" alt="" height="280"
                                width="350">
                        </div>
                        <div class="width-common blog-content">
                            <div class="blog-title">
                                <h3 class="title-preview">Tại sao sữa tắm Thái Lan được yêu thích?</h3>
                            </div>
                            <div class="blog-preview-content width-common">
                                Sữa tắm của Thái thường mang mùi hương của sữa hoặc hương nước hoa quyến rũ
                                từ các loài hoa và trái cây. Sữa tắm Thái Lan có đặc trưng thơm dai, thơm lâu
                                nên sau khi vừa tắm xong, bạn sẽ cảm nhận được da dẻ thơm tho như vừa xịt nước
                                hoa và mùi hương này sẽ duy trì suốt nhiều giờ đồng hồ.
                            </div>
