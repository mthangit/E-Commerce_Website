...
<div class="page-navigation">
    <ul class="breadcrumb">
        ...
        @endguest
        <li><a
                href="{{ route('product list with category', ['categorySlug' => $category_list->categorySlug]) }}">{{ $category_list->categoryName }}</a>
        </li>
    </ul>
</div>
            ...
            @foreach ($list_products as $product)
                <div class="preview-product">
                    <div class="product-ping width-common relative">
                        <a href="{{ route('detail product', ['categorySlug' => $category_list->categorySlug, 'subCategorySlug' => getSubCategoryByProductID($product->productID)->subCategorySlug, 'productSlug' => $product->productSlug]) }}"
